...
d3.json('data/departments_officers.json').then(data_all => {
    ...
    var x_var_selection="years_in_2016"
    var data=[]
    ...
    for (let d of data){
        ...
        d.x_var=+d[x_var_selection],
        d.color_var=+d.x_var 

    }
    console.log(data)

    //color = d3.scaleSequential(d3.extent(data[33], d => d.color_var*1.5), d3.interpolateOrRd); // this should be bucketed
    ...
    myBubbleChart(data,"Complaints","Years on CPD Roster")
