...
//d3.json().then(data => {
d3.json("/data/extra_data/departments_basic.json").then(data => {
    console.log(data)

    for (let d of data) {
        d.headcount = +d.headcount; //force a number
    };

    data.sort((a, b) => a.headcount - b.headcount);
